...
import about from '../assets/images/me2.jpg';
        ...
        <div className="flex md:flex-row flex-col-reverse items-center md:gap-6 gap-12 px-10 max-w-6xl mx-auto">
          <div className="p-2">
            <div className="text-gray-300 my-3">
              ...
              <br />
              <br />
              <a href="./src/assets/AnuskaKohli_Resume.pdf" download>
              <button type="button" className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-6 py-3 text-center mr-2 mb-2 mt-8">Download Resume</button>
              </a>
            </div>
          </div>
